...
export default function SpanPageContentsComponent() {
    ...
    function getSpans() {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, axios.get("/spans")];
                    case 1:
                        result = _a.sent();
    ...
    return (React.createElement("div", { className: "contents" },
        React.createElement(Pagination, { count: 10, size: "large" }),
        spans.map(function (data) { return (React.createElement(SpanCardComponent, { data: data })); })));
}
