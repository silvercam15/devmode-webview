...
function SpanPageContentsComponent() {
    ...
    return (React.createElement("div", { className: "contents" },
        React.createElement(material_1.Pagination, { count: 10, size: "large" }),
        React.createElement("h1", null, "Traces"),
        testData.map(function (data) { return (React.createElement(spanCardComponent_1["default"], { data: data })); })));
}
